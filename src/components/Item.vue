<template>
  <div class="item-container">
    <button 
      v-if="!collected"
      class="bg-black text-sage border-2 border-sage px-6 py-3 rounded-lg hover:bg-sage hover:text-black transition-colors duration-200 font-bold text-responsive-base md:text-responsive-lg"
