...
export const translations: Translations = {
  ...
  // Footer component
  'footer.copyright': {
    en: '<a href="about" class="text-sage hover:text-sage-deep underline transition-colors duration-200">A Cloudinary Experiment</a>. Stay Curious!',  
    fr: '<a href="about" class="text-sage hover:text-sage-deep underline transition-colors duration-200">Une Expérience Cloudinary</a>. Restez Curieux !',  
    es: '<a href="about" class="text-sage hover:text-sage-deep underline transition-colors duration-200">Un Experimento de Cloudinary</a>. ¡Mantente Curioso!',
    'pt-br': '<a href="about" class="text-sage hover:text-sage-deep underline transition-colors duration-200">Um Experimento Cloudinary</a>. Mantenha-se Curioso!'
  },

  // About page
  'about.content': {
    en: '<p>Cloudinary Experiments are apps that explore Cloudinary\'s image, video, and audio transformation capabilities.</p> <p>The images in this game were generated by ChatGPT. Each backdrop image uses the "fl_c2pa" transformation to help trace provenance using the C2PA standard. Learn more about C2PA <a href="https://c2pa.org" target="_blank" class="text-primary hover:text-primary underline">here</a>. Learn more about this transformation at <a href="https://cloudinary.com/documentation/image_transformations#c2pa_transformation" target="_blank" class="text-primary hover:text-primary underline">Cloudinary documentation</a>.</p>',
    fr: '<p>Les Expériences Cloudinary sont des applications qui explorent les capacités de transformation d\'images, vidéos et audio de Cloudinary.</p> <p>Les images de ce jeu ont été générées par ChatGPT. Chaque image de fond utilise la transformation "fl_c2pa" pour aider à tracer la provenance en utilisant le standard C2PA. En savoir plus sur C2PA <a href="https://c2pa.org" target="_blank" class="text-primary hover:text-primary underline">ici</a>. En savoir plus sur cette transformation dans la <a href="https://cloudinary.com/documentation/image_transformations#c2pa_transformation" target="_blank" class="text-primary hover:text-primary underline">documentation Cloudinary</a>.</p>',
    es: '<p>Los Experimentos de Cloudinary son aplicaciones que exploran las capacidades de transformación de imágenes, videos y audio de Cloudinary.</p> <p>Las imágenes de este juego fueron generadas por ChatGPT. Cada imagen de fondo usa la transformación "fl_c2pa" para ayudar a rastrear la procedencia usando el estándar C2PA. Aprende más sobre C2PA <a href="https://c2pa.org" target="_blank" class="text-primary hover:text-primary underline">aquí</a>. Aprende más sobre esta transformación en la <a href="https://cloudinary.com/documentation/image_transformations#c2pa_transformation" target="_blank" class="text-primary hover:text-primary underline">documentación de Cloudinary</a>.</p>',
    'pt-br': '<p>Os Experimentos Cloudinary são aplicativos que exploram as capacidades de transformação de imagens, vídeos e áudio do Cloudinary.</p> <p>As imagens neste jogo foram geradas pelo ChatGPT. Cada imagem de fundo usa a transformação "fl_c2pa" para ajudar a rastrear a procedência usando o padrão C2PA. Saiba mais sobre C2PA <a href="https://c2pa.org" target="_blank" class="text-primary hover:text-primary underline">aqui</a>. Saiba mais sobre esta transformação na <a href="https://cloudinary.com/documentation/image_transformations#c2pa_transformation" target="_blank" class="text-primary hover:text-primary underline">documentação do Cloudinary</a>.</p>'
  },
